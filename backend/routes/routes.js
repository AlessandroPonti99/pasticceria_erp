...
router.get('/invoices/outgoing', verifyToken, (req, res) => {
...
// POST - nuova fattura
router.post('/invoices/outgoing', verifyToken, (req, res) => {
  const {
...
// PUT - emetti fattura
router.put('/invoices/outgoing/:id/emit', verifyToken, (req, res) => {
